...
export default function StokLelePage() {
  ...
  useEffect(() => {
    const loadData = () => {
      const stored = localStorage.getItem('imported_fish_lele');
      if (stored) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {leleStock.length === 0 ? (
          <div className="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-12 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Belum Ada Data Stok Lele</h3>
            <p className="text-gray-600 mb-6">
              Upload file Excel/CSV untuk mulai tracking stok ikan lele Anda
            </p>
            <Link
              href="/pemancingan/import"
