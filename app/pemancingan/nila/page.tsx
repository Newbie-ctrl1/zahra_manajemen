...
export default function StokNilaPage() {
  ...
  const exportToPDF = async () => {
    ...
    doc.setFontSize(18);
    doc.text('Laporan Stok Nila', 14, 20);
  ...
  const exportToExcel = async () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Stok Nila');
    XLSX.writeFile(wb, 'stok-nila.xlsx');
  };
